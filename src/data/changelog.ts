...
export const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    badge: "feat",
    highlights: [
      "🆕 学んだ内容を 4 人の相手 (エンジニア / 初学者 / 中学生 / おばあちゃん) に説明し直す専用ページ /feynman を新設 (ロードマップの言語化フェーズから遷移)",
      "✨ 厳選お題 (クロージャ / Promise・async / 正規化 / インデックス / merge・rebase / any・unknown) には相手別の模範回答を用意。自分で書いてから『模範回答を見る』で見比べられる",
      "💾 トピックと各説明はこの端末に自動保存",
    ],
  },
  {
    version: "2026-05-29-h",
    date: "2026-05-29",
    title: "🗣️ 全トラックに『学びを言語化する』フェーズを追加 (ファインマン式)",
    badge: "feat",
    highlights: [
      "🆕 これまで Ruby だけにあった言語化フェーズを、全ロードマップの末尾に統一付与",
      "🧠 お題はファインマン・テクニック — 学んだ内容を『エンジニア仲間 / 初学者 / 中学生 / おばあちゃん』の 4 人に説明し直す。詰まった所が『まだ理解できていない所』",
      "📝 あわせて週次振り返り (KPT / PREP) のステップも用意",
    ],
  },
  {
    version: "2026-05-29-g",
    date: "2026-05-29",
    title: "🧩 Rails 以外のクイズを大幅拡充 (各トラック約 40 問に)",
    badge: "content",
    highlights: [
      "📈 Next.js / Git / Nuxt / Linux / セキュリティ を各 20 問台 → 約 39 問、React / Python / TypeScript を 30 → 40 問に拡充 (合計 +130 問)",
      "📚 各問は参考書の章に対応づけ、難易度を初級〜上級でミックスして理解を深められる構成に",
      "🗂️ DB 設計には『達人に学ぶDB設計』のトピック (BCNF / バッドノウハウ / 木構造の表現 等) を 13 問追加",
    ],
  },
  {
    version: "2026-05-29-f",
    date: "2026-05-29",
    title: "🔧 クイズ・フラッシュカードの表示不具合を修正",
    badge: "fix",
    highlights: [
      "🎯 一部の設問で正解が『1 と 2』のように番号参照になり意味をなさなかった問題を、選択肢を自己完結テキストに書き換えて修正 (9 問)",
      "🃏 クイズから作ったフラッシュカードが一覧で問題文・正解とも一部しか表示されなかったのを、クリックで全文展開できるように",
    ],
  },
  {
  ...
  },
  {
    ...
    badge: "feat",
    highlights: [
      "🆕 グループを作成し、 招待コードで仲間を招待 / 参加できるように (ログイン時のみ・ヘッダー『グループ』から)",
      "📣 グループのフィードに自由投稿 — スタンプ (6 種) とコメントで反応し合える",
      "🔗 ジャーナル / 自己説明から『👥 グループに共有』 — 内容をスナップショットしてグループに投稿 (opt-in)",
      "🔒 同じグループのメンバーだけが投稿を読める (DB レベルの行レベルセキュリティで保護)",
    ],
  },
  {
    version: "2026-05-29-c",
    date: "2026-05-29",
    title: "🧑 プロフィール設定 (表示名・アイコン) を追加",
    badge: "feat",
    highlights: [
      "✏️ グループで表示される表示名とアイコン画像を自分で設定可能に (アバターメニュー → プロフィール設定)",
      "🖼 設定した名前・アイコンはヘッダーや既存グループの表示にも反映",
      "↩️ 『GitHub のアイコンに戻す』 でいつでも既定に戻せる",
    ],
  },
  {
    version: "2026-05-29-b",
    date: "2026-05-29",
    title: "🔁 端末間で学習進捗が揃わない問題を修正 + 読み込みを高速化",
    badge: "fix",
    highlights: [
      "🩹 ログイン済みでも別端末で進めた進捗がリロード時に取り込まれなかった問題を修正 (セッション復元時にも同期するように)",
      "⚡ フォーカス復帰 / 一定間隔でも自動で取り込み、 複数端末の進捗が揃うように",
      "🚀 ページ読み込みごとの重い全件アップロードをやめ、 不要なネットワーク往復も削減してグループ画面やアイコン表示を高速化",
    ],
  },
  {
